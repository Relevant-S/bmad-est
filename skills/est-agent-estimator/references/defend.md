...
`manual_equivalent.build_hours` in `estimate.json` is the honest anchor here: it is what a human team would have spent writing this code, and it is the number their intuition is actually calibrated against.
